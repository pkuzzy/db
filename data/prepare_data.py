...
# bike.write("bike_id,bike_type,bike_state, cost_per_min,bike_location\n")
...
for dis in range(len(district)):
	for ss in range(len(street[dis])):
		for i in range(9):
			cnt = cnt + 1
<<<<<<< HEAD
			bike.write("%08d %02d %02d %.2f %08d\n"%(cnt, random.randint(0, 2), random.randint(0, 1), random.uniform(0.50, 2.50), cnt))
=======
			bike.write("%08d,%02d,%.2f,%08d\n"%(cnt, random.randint(0, 1), random.uniform(0.50, 2.50), cnt))
>>>>>>> 59bd705ed031718c3f2a1ebb20d61f763d9560b3
